...
module.exports = class Slots extends events {
  ...
  getBoardContent(showResult) {
    ...
    board += `${this.wrap((this.slot1), true)}  :  ${this.wrap((this.slot2), true)}  :  ${this.wrap((this.slot1), true)}\n`;
    board += '-------------------\n';
  ...
  slotMachine() {
    ...
    } else if (chance > 700000 && chance <= 900000) {
      this.slot1 = this.slot2 = this.slot3 = 0;
    } else if (chance > 900000  && chance <= 975000) {
      this.slot1 = this.slot2 = this.slot3 = 1;
    } else if (chance > 975000 && chance < 99999) {
      this.slot1 = this.slot2 = this.slot3 = 2;
    } else if (chance === 999999) {
      this.slot1 = this.slot2 = this.slot3 = 3;
    }
    console.log(this.slot1, this.slot2, this.slot3);
  }


  hasWon() {
    return (this.slots[this.slot1] === this.slots[this.slot2] && this.slots[this.slot1] === this.slots[this.slot3]);
  }
