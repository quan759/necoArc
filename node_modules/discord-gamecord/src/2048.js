...
module.exports = class TwoZeroFourEight extends events {
  constructor(options = {}) {
    ...
    if (!options.embed.currentScore) options.embed.currentScore = 'Current Score';
    ...
    if (typeof options.embed.currentScore !== 'string') throw new TypeError('INVALID_EMBED: currentScore must be a string.');
  ...
  async startGame() {
    ...
    .addFields({ name: this.options.embed.currentScore, value: this.score.toString() })
